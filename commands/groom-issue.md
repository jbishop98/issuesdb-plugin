---
description: Groom an issue from the issuesdb tracker (any project) — clarify scope, acceptance criteria, and readiness for implementation
argument-hint: <issue-id> [id2 id3 ...] (optional — omit to auto-select; multiple IDs run in parallel batch mode)
---
